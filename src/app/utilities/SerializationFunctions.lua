...
local WRITABLE_PATH	 = (cc.FileUtils:getInstance():getWritablePath() .. "writablePath/") or (nil)
local ACCOUNT_FILE_PATH = (WRITABLE_PATH  .. "LoggedInAccount.lua")						 or (nil)
...
function SerializationFunctions.init()
	...
	s_Sproto = sproto.new(read_sproto_file_c(filename))
end
