...
--------------------------------------------------------------------------------
function ModelFogMap:ctor(param, warFieldData)
	param = param or {}
	self.m_MapSize						  = {width=warFieldData.width,height=warFieldData.height}
	...
	for playerIndex = 1, warFieldData.playersCount do
