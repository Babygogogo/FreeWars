...
local getActionCode				 = requireFW("src.app.utilities.ActionCodeFunctions").getActionCode
...
local GAME_VERSION		 = requireFW("src.app.utilities.GameConstantFunctions").getGameVersion()
