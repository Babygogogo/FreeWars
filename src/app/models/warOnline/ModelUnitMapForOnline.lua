...
-- The unit actors map.
--------------------------------------------------------------------------------
local function createActorUnitsMapWithWarFieldData(warFieldData)
	local layer			   = warFieldData.layers[3]
...
local function createActorUnitsMapWithUnitMapData(unitMapData, warFieldData)
	local layer		 = warFieldData.layers[3]
...
--------------------------------------------------------------------------------
function ModelUnitMapForOnline:ctor(unitMapData,warFieldData)
	if (unitMapData) then
		self.m_ActorUnitsMap, self.m_MapSize, self.m_AvailableUnitID, self.m_LoadedActorUnits = createActorUnitsMapWithUnitMapData(unitMapData,warFieldData)
	else
		self.m_ActorUnitsMap, self.m_MapSize, self.m_AvailableUnitID, self.m_LoadedActorUnits = createActorUnitsMapWithWarFieldData(warFieldData)
	end
