...
local function createActorTilesMapWithWarFieldData(warFieldData)
	...
	return map, {width = warFieldData.width, height = warFieldData.height}
end
...
local function resetActorTilesMap(map, mapSize,warFieldData)
...
--------------------------------------------------------------------------------
function ModelTileMapForNative:ctor(param,warFieldData)
	if (self.m_ActorTilesMap) then
		resetActorTilesMap(self.m_ActorTilesMap, self.m_MapSize,warFieldData)
		updateActorTilesMapWithTilesData(self.m_ActorTilesMap, self.m_MapSize.height, param.tiles)
	else
		local map, mapSize = createActorTilesMapWithWarFieldData(warFieldData)
